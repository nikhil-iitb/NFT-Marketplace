...
app.get("/soltoinr", (request, response) => {
  var soltoinr = "";
    ...
    db.getConnection(async (err, connection) => {
      ...
      await connection.query(SQLQUERY, (err, result) => {
        ...
        db.getConnection(async (err, connection) => {
          ...
          const sql_query = mysql.format(sql_insert, [name, description, price, blockchain, image, collectionName, hash, public_key, 0, 0, user_id ]);
