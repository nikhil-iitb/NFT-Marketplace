...
class Partysnippet extends React.Component {

    constructor(props) {
        super(props);
        this.state = {
           liked_comment_id: 1, returnedimageurls:[], group_id:1, webpage_id:1, comment:'', liked: 0,user_id: localStorage.getItem('user_id'), returnedcomments:[], comment_id:0
        };
    ...
    componentDidMount() {
      ...
      let group_id=Number(both_ids.split('&')[0]);
        ...
        const api_url = "http://localhost:3000/fetchimages/"+group_id+"/1";
      Promise.all([
    ...
    return (
      <div className="partysnippet">
        <div className="container-fluid">
            ...
            <div id="p01">
            BAYC parties aren't just parties, but a genuine hub for group of 
            individuals who have done something significant in life. We discuss
            music, art, politics and the most important future while having fun
            </div>
            <div className="Snippet-images">
                    {/* <img id="p02" src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg"></img>
                    <img id="p02" src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg"></img>
                    <img id="p02" src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg"></img>
                    <img id="p02" src="https://cdn.pixabay.com/photo/2015/04/23/22/00/tree-736885__480.jpg"></img> */}
                    {/* <img src="http://localhost:3001/upload/electroshoe.png-1639653105568.png"/> */}
